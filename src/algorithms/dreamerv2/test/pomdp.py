...
from dreamerv2.utils.wrapper import make_crafter
...
def main(args):
    ...
    env = OneHotAction(make_crafter(env_name, scale=True, gray_scale=False, frame_stack = 1, image_size=64, capture_video = False))
    ...
    with wandb.init(project='crafter', config=config_dict):
        """training loop"""
        print('...training...')
        train_metrics = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, help='mini atari env name', default="CrafterReward-v1")
